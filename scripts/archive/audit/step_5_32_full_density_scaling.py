...
def run_full_density_scaling():
    ...
    # Observed Data (Schematic for comparison - 0.10 slope)
    ...
    y_obs_proj = 0.10 * (x_range - mean_rho) + mean_shift
    plt.plot(x_range, y_obs_proj, '#E94F37', linestyle='--', linewidth=1.5, label='Observed Data (Slope=0.10)')
