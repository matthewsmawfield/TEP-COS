...
logging.basicConfig(
    ...
    format=log_format,
    handlers=[
        logging.FileHandler('logs/step_62_sn_ia_stretch_test.log', mode='w'),
...
def main():
    ...
    # Save JSON outputs
    save_json_output(results_mB, 'step_62_sn_ia_mB_sigma.json')
    save_json_output(results_stretch, 'step_62_sn_ia_stretch_sigma.json')
