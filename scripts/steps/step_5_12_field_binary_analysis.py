#!/usr/bin/env python3
"""
Step 5.12: Field Binary Pulsar Analysis
...
This script:
1. Loads the ATNF pulsar catalog (cached from Step 5.10).
...
# Inputs (from Step 5.10)
ATNF_DB_PATH = RESULTS_DIR / "atnf_psrcat.db"
ATNF_TGZ_PATH = RESULTS_DIR / "atnf_psrcat_pkg.tar.gz"

# Outputs
OUT_JSON = RESULTS_DIR / "step_5_12_field_binary_analysis.json"
OUT_MD = RESULTS_DIR / "step_5_12_field_binary_analysis.md"
