#!/usr/bin/env python3
"""
Step 14: CMC Literature Comparison
=====================================
...
OUTPUT_JSON = RESULTS_DIR / "step_14_cmc_literature.json"
OUTPUT_MD = RESULTS_DIR / "step_14_cmc_literature.md"
...
OBSERVED_SCALING = {
    "slope": 0.393,
    "error": 0.079,
    "reference": "Step 14 hierarchical mixed-effects model",
    "n_clusters": 33,
}
...
def load_observed_data():
    ...
    # Try step_12 first
    s533_path = RESULTS_DIR / "step_12_hierarchical_density_results.json"
    if s533_path.exists():
