...
RAW_OUT_PATH = RESULTS_DIR / "freire_GCpsr.txt"
SUMMARY_CSV_PATH = RESULTS_DIR / "freire_gcpsr_radial_summary.csv"
SUMMARY_JSON_PATH = RESULTS_DIR / "freire_gcpsr_radial_summary.json"
SUMMARY_MD_PATH = RESULTS_DIR / "freire_gcpsr_radial_summary.md"
