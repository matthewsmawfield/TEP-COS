...
OUTPUT_JSON = RESULTS_DIR / 'step_7_1_tep_vs_mass_step.json'
OUTPUT_MD = RESULTS_DIR / 'step_7_1_tep_vs_mass_step.md'

# Load previous results
def load_sn_ia_results():
    """Load the SN Ia analysis results."""
    mB_path = RESULTS_DIR / 'step_7_0_sn_ia_mB_sigma.json'
    stretch_path = RESULTS_DIR / 'step_7_0_sn_ia_stretch_sigma.json'
