...
Usage:
    from scripts.steps.step_00_data_acquisition import ensure_data
...
DATA_SOURCES: Dict[str, Dict] = {
    "freire_gcpsr": {
        ...
        "path": DATA_DIR / "freire_GCpsr.txt",
        "type": "text",
        "required_for": ["pulsars"],
    },
    "atnf_psrcat": {
        "url": "https://www.atnf.csiro.au/research/pulsar/psrcat/downloads/psrcat_pkg.tar.gz",
        "path": DATA_DIR / "atnf_psrcat_pkg.tar.gz",
        "extract_to": DATA_DIR / "atnf_psrcat.db",
        "type": "tgz",
        "required_for": ["pulsars"],
    },
}
