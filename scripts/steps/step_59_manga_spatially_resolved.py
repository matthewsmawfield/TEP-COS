...
"""
    ...
    fig_path = os.path.join(FIGURES_DIR, 'step_59_manga_age_gradients.png')
...
def main():
    ...
    # Save results
    results_path = os.path.join(RESULTS_DIR, 'step_59_manga_spatially_resolved.json')
    
    def convert_types(obj):
        """Recursively convert numpy types to Python native types for JSON serialization.
        
        Args:
            obj: Object to convert (numpy scalar, dict, list, or other)
