#!/usr/bin/env python3
"""
Step 56: Spatial Gradient Analysis
=====================================
...
OUTPUT_JSON = RESULTS_DIR / "step_56_spatial_gradient.json"
OUTPUT_MD = RESULTS_DIR / "step_56_spatial_gradient.md"
    ...
    for line in lines:
        ...
        if line.startswith(('J', 'B')):
            ...
            if len(parts) >= 4:
                ...
                # This matches step_02 methodology and prevents canonical
...
def load_cluster_properties():
    ...
    # From step_12 or step_11 outputs
    cluster_data = {
...
def main_analysis():
    ...
    # Load field mean from step_02 - REQUIRED
    field_json = RESULTS_DIR / "step_02_pulsar_population_controls.json"
    if not field_json.exists():
        print(f"ERROR: Required input file not found: {field_json}")
        print(f"Spatial gradient analysis requires population control results from step_02.")
...
*Report generated by step_56_spatial_gradient.py*
"""
