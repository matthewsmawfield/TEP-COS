...
OUTPUT_DIR = PROJECT_ROOT / "site" / "figures"
...
def parse_catalog(text: str):
    ...
    for line in text.splitlines():
        ...
        # Cluster detection (simplified from step_15)
...
def main():
    ...
    with open(STATS_DIR / "step_45_binary_spatial_stats.json", "w") as f:
    ...
    out_png = OUTPUT_DIR / "step_45_binary_spatial_distribution.png"
