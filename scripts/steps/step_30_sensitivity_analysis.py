#!/usr/bin/env python3
"""
Step 30: Sensitivity Analysis for Cluster Parameters
==========================================================
...
OUTPUT_JSON = RESULTS_DIR / "step_30_sensitivity_analysis.json"
...
def predict_newtonian_shift(params, n_pulsars=1000, seed=None):
    ...
    if s10_path.exists():
        ...
        log_pdot_intrinsic = -19.5  # Fallback
...
def run_monte_carlo_sensitivity(n_iterations=1000):
    ...
    print(f"\nRobustness Test:")
    print(f"  Observed residual: {observed_residual:.3f} ± {observed_uncertainty:.3f} dex (loaded from step_02)")
