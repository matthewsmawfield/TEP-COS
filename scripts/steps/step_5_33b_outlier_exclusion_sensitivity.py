#!/usr/bin/env python3
"""
Step 5.33b: Outlier Exclusion Sensitivity Analysis for Density Scaling
======================================================================
...
OUTPUT_JSON = RESULTS_DIR / "step_5_33b_outlier_exclusion_results.json"
...
def run_outlier_exclusion_analysis(gc_df):
    ...
    print(f"  Tension with Newtonian (0.72): {full_result['significance_sigma']:.1f}σ")
...
def interpret_results(results, top_clusters):
    ...
    if all_significant:
        interpretation['robustness_conclusion'] = (
            ...
            f"vs Newtonian 0.72) with >{min_sigma:.0f}σ significance."
        )
    else:
        interpretation['robustness_conclusion'] = (
    ...
    interpretation['reviewer_response'] = (
        ...
        f"The suppressed scaling (slope < 0.72) persists in all cases, with significance "
