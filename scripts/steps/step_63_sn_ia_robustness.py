...
Dependencies:
- Requires output from step_62_sn_ia_stretch_test.py
...
# Apply z > 0.01 filter to match step_62
...
# Apply quality cuts (matches step_62: σ > 30, σ <= 400)
...
all_sig = all([
    ...
    all(r['pearson_p'] < 0.05 for r in subsample_results.values()),  # subsamples too
])
...
# Save results
with open('results/outputs/step_63_robustness_analysis.json', 'w') as f:
    json.dump(results, f, indent=2)

print("\nResults saved to: results/outputs/step_63_robustness_analysis.json")
