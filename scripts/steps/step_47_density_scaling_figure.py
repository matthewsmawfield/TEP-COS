#!/usr/bin/env python3
"""
Step 47: Full Density Scaling Simulation (Addressing the 'Killer' Counter-Argument)
...
def run_full_density_scaling():
    print("--- Step 47: Full Density Scaling Simulation ---")
    ...
    with open("results/outputs/step_47_density_scaling_figure.json", "w") as f:
        json.dump(out_data, f, indent=4)

    print("Results saved to results/outputs/step_47_density_scaling_figure.json")
    ...
    plt.savefig("site/figures/step_47_density_scaling_rigorous.png", dpi=300)
    print("Updated rigorous plot saved to site/figures/step_47_density_scaling_rigorous.png")
