#!/usr/bin/env python3
"""
Step 5.27: Hybrid Maximum Analysis

Start with robust step_5_10 data, then expand by:
...
OUT_JSON = RESULTS_DIR / "step_5_27_hybrid_maximum_analysis.json"
OUT_CSV = RESULTS_DIR / "step_5_27_hybrid_pulsar_sample.csv"
OUT_MD = RESULTS_DIR / "step_5_27_hybrid_maximum_analysis.md"

# Existing data
STEP_5_10_CSV = RESULTS_DIR / "step_5_10_pulsar_population_controls.csv"
FREIRE_TXT = DATA_DIR / "freire_gcpsr_2025.txt"


def load_step_5_10_data():
    """Load the robust step_5_10 parsed data."""
    gc_rows = []
    field_rows = []
...
def main():
    ...
    print("\nLoading step_5_10 robust data...")
    gc_base, field_base = load_step_5_10_data()
