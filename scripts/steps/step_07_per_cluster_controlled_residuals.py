#!/usr/bin/env python3
"""
Step 07: Per-Cluster Controlled Residuals
...
OUT_JSON = RESULTS_DIR / "step_07_per_cluster_controlled_residuals.json"
OUT_MD = RESULTS_DIR / "step_07_per_cluster_controlled_residuals.md"
