#!/usr/bin/env python3
"""
Step 5.37: Sensitivity Analysis for Intra-Cluster Correlation (rho_intra)
...
def main():
    ...
    # A+ Grade: Expanded range including 0.0 (no correlation) to 0.7 (very high correlation)
    ...
    with open('results/outputs/step_5_37_rho_sensitivity.json', 'w') as f:
        json.dump(output, f, indent=2)
    
    print(f"\nResults saved to: results/outputs/step_5_37_rho_sensitivity.json")
    print("=" * 70)
