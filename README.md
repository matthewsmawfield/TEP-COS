...
**Paper Series:** TEP Series: Paper 11 (Cosmological Evidence)
...
│   ├── freire_gcpsr_2025.txt     # Freire GC pulsar catalog
│   ├── cosmograil/               # COSMOGRAIL lensing light curves (.rdb)
│   ├── pulsars/                  # Pulsar reference data
│   ├── clusters/                 # Cluster structural parameters
│   └── archive/                  # Archived intermediate data (not needed for reproduction)
├── scripts/
│   ├── steps/                    # Analysis scripts (run via reproduce_manuscript.py)
│   ├── utils/                    # Utility functions
│   └── archive/                  # Archived exploratory scripts
├── results/
│   ├── outputs/                  # Core analysis results (JSON, CSV, MD)
│   │   └── archive/              # Archived intermediate outputs
│   └── figures/                  # Generated plots
│       ├── manuscript/           # Figures for manuscript
│       └── archive/              # Archived exploratory figures
├── site/
│   ├── components/               # Manuscript HTML sections
│   └── figures/                  # Figures embedded in manuscript
├── reproduce_manuscript.py       # Master reproduction script
...
To reproduce all results, run the master script:

```bash
python3 reproduce_manuscript.py
```
