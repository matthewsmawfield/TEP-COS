...
Maximum systematic (0.23 dex) explains only 65% of observed suppression (0.35 dex). Remaining 0.12 dex (1.6σ) requires non-systematic explanation.
...
3. **Remaining unexplained signal** (0.12 dex, 
